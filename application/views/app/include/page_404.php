<?php $this->load->view('app/include/header.php'); ?>
    ...
    <link rel="stylesheet" href="<?=base_url('assets/Admselect2inLTE-2.4.3/plugins/iCheck/all.css')?>">
...
<!--    <link rel="stylesheet" href="--><?//=base_url('assets/AdminLTE-2.4.3/bower_components/select2/dist/css/select2.min.css')?><!--">-->
    ...
    <link rel="stylesheet" href="<?=base_url('assets/myAssets/css/404error.css')?>">
                ...
                <div class="error-page">
                    ...
                    <div class="error-content">
                        ...
                        <p>
                            ...
                            Bom, recomendamos que você retorne para a  <a href="<?= base_url('Dashboard') ?>">Dashboard</a>.
                        </p>

                        <form class="search-form">
                            <div class="input-group">
                                <div class="input-group-btn">
<!--                                    <button onclick="location.href='--><?php //echo base_url('Dashboard');?>//'" class="btn btn-warning btn-flat"><i class="fa fa-reply"></i>Voltar para Dashboard</button>


                                    <a class="btn btn-warning btn-flat" href="<?= base_url('Dashboard') ?>"><i class="fa fa-reply"></i> Voltar para Dashboard</a>
                                </div>
                            </div>
                            <!-- /.input-group -->
                        </form>
