...
<!-- My JS -->
<script src="<?=base_url('assets/assets/js/cadUsuario.js')?>"></script>
<script src="<?=base_url('assets/assets/js/time.js')?>"></script>
<script src="<?=base_url('assets/assets/js/ponto.js')?>"></script>
<script src="<?=base_url('assets/assets/js/perfil.js')?>" charset="UTF-8"></script>
