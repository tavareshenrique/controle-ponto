    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="https://www.controledeponto.com">Controle de Ponto</a>.</strong> Todos os direitos reservados.
    </footer>
    ...
    <!-- My JS-->
    <script src="<?=base_url('assets/myAssets/js/script.js')?>"></script>
    <script src="<?=base_url('assets/myAssets/js/time.js')?>"></script>
    <script src="<?=base_url('assets/myAssets/js/ponto.js')?>"></script>
