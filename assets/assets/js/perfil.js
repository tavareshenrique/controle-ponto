...
let cadPerson = document.querySelector("#saveData");
if (cadPerson != null) {
...
let cadPass = document.querySelector("#changePass");
if (cadPass != null) {
...
function doCheckStatusTime(time) {
    if (time == 'Sim') {
...
function userStatus() {
    ...
    $("input[name='usuario']").blur( function(){
        ...
        let nomeUsuario = $("input[name='usuario']").val();
